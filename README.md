...
* 2026.08.19. 오프라인 캐시 정상화, PWA 설치 버튼 개선
* 2026.09.01. 반응형 개선 - 큰 요소를 min(vw,vh)로 세로 예산에 묶고, dvh·box-sizing·flex 2열 적용으로 다양한 화면비에서 잘림 방지
* 2026.09.09. 뮤직 플레이어 URL 히스토리 표시
* 2026.09.10. 빌드 번호 표시 (Build 313.260910)
* 2026.09.11. 뮤직 히스토리 hover 가독성, 기본 YouTube URL
